---
title: 可変ボリューム
description: 可変ボリュームコントロールは、まず、ユーザーがスマート切り抜きビデオプレーヤーのサウンドをミュートまたはミュート解除できるボタンとして表示されます。
...
可変ボリュームコントロールは、まず、ユーザーがスマート切り抜きビデオプレーヤーのサウンドをミュートまたはミュート解除できるボタンとして表示されます。
