---
title: 全画面表示ボタン
description: フルスクリーンボタンを使用すると、ユーザーがクリックしたときに、スマート切り抜きビデオプレーヤーがフルスクリーンモードに入ったり終了したりします。
...
フルスクリーンボタンを使用すると、ユーザーがクリックしたときに、スマート切り抜きビデオプレーヤーがフルスクリーンモードに入ったり終了したりします。
