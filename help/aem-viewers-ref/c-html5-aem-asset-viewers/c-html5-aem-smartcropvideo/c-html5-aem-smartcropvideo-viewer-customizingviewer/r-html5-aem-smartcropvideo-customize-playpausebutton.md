---
title: 再生/一時停止ボタン
description: 再生/一時停止ボタンを使用すると、ユーザーがクリックしたときに、スマート切り抜きビデオプレーヤーでビデオコンテンツを再生または一時停止できます。
...
>
>属性セレクター `replay='true'` はビデオが終了に達したときに設定され、ボタンを選択すると最初から再生が再開されます。
...
32 x 32 ピクセルの再生/一時停止ボタンを設定します。 コントロールバーの上端と左端から 6 ピクセル離して配置します。 最後に、選択または未選択の場合、4 つの異なるボタン状態ごとに異なる画像を表示します。
