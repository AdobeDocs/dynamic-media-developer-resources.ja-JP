---
title: 再生/一時停止ボタン
description: 再生/一時停止ボタンを使用すると、ユーザーがビデオコンテンツをクリックしたときに、スマート切り抜きビデオプレーヤーがビデオコンテンツを再生または一時停止します。
...
再生/一時停止ボタンを32 x 32 ピクセルに設定するには、次の手順を実行します。 コントロールバーの上端と左端から6 ピクセル配置する。 最後に、ボタンの状態が4つずつ異なる場合は、選択または選択されていない場合は、それぞれ異なる画像を表示します。
