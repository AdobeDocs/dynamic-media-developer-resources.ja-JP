...
>
>属性`replay='true'`は、ビデオが最後に達し、ボタンを選択すると最初から再生が再開されるときに設定されます。
...
コントロールバーの上端と左端から6 ピクセルに位置する32×32 ピクセルの再生/一時停止ボタンを設定する。 最後に、選択または選択されていない4つの異なるボタンの状態ごとに異なる画像が表示されます。
