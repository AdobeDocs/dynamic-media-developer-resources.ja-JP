...
詳しくは、ユー [ザインターフェイス要素のローカリゼーションを参照してくださ](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74)い。
...
クローズドキャプションのテキストを14ピクセル、ライトグレー、Arialで、半透明の黒の背景に設定するには：
