...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph">個のインタラクティブスウォッチ </span> </p> </td> 
...
SDK APIを使用する場合は、[Viewer SDK名前空間](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-html5-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)の説明に従って、正しい、完全修飾されたSDK名前空間を使用することが重要です。
