...
<table id="table_2A4F898BBF88417DB0834B7F78637F5D"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 初回読み込み時のビデオ再生のミュートモードを設定します。 <span class="codeph">1 に設定すると音量はミュート </span>、設定しないとビデオはサウンドで再生されます。 特定のデバイスでは、読み込み時にビデオの再生をミュートすると、ビデオが自動再生されます。 </p> </td> 
  </tr> 
 </tbody> 
</table>
