...
<table id="table_C616483932C2482CA9794DDD7313FD7C"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> ポスター画像の外観を制御する画像サービング修飾子 URL で指定する場合は、次の内容を HTTP エンコードします。 </p> <p> 
     ...
     </ul> </p> <p> この修飾子は、Dynamic Media ClassicまたはAdobe Experience Manager、Dynamic Mediaでホストされるビデオコンテンツに対して機能します。 </p> <p>初期設定のポスター画像を表示しないようにするには、ポスター画像の値として <span class="codeph"> none</span> を指定します。 </p> </td> 
  </tr> 
 </tbody> 
</table>
