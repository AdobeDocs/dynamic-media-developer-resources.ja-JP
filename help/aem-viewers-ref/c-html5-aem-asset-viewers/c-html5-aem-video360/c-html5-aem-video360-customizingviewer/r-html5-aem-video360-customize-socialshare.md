...
TQID: 'https://experienceleague.adobe.com/b-P1gG2KVPiUXWXiXxdU429rxVAyF28NNpea6-USoyU'
...
**例** - ビューア コンテナの上部から4 ピクセル、右側から5 ピクセルに配置され、サイズが28 x 28 ピクセルのソーシャル共有ツールを設定します。
...
**例** - 4つの異なるボタンの状態ごとに異なる画像を表示するソーシャル共有ツール ボタンを設定します。
