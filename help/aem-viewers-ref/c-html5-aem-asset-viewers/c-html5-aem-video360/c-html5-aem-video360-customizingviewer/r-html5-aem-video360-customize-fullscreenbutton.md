...
フルスクリーンボタンをクリックすると、ビデオプレーヤーがフルスクリーンモードに入るか、または終了します。
...
**例** - 32 x 32 ピクセルで、コントロールバーの上および右端から 6 ピクセルの位置に配置するフルスクリーンボタンを設定する場合。 また、選択時または未選択時の 4 つの異なるボタン状態ごとに異なる画像を表示します。
