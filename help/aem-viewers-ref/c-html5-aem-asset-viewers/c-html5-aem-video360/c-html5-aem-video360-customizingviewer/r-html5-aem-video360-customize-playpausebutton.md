...
TQID: 'https://experienceleague.adobe.com/nEiIyfYB7B4MhqnMpH36eB6AHdwZFhPy9MfKFC6CtDc'
...
**例** - 32 x 32 ピクセルの再生/一時停止ボタンを設定します。 コントロールバーの上端と左端から6 ピクセル配置する。 最後に、選択または選択されていない4つの異なるボタンの状態ごとに異なる画像が表示されます。
