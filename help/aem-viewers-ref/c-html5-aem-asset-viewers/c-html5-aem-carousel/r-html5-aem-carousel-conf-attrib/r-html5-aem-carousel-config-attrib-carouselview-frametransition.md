...
` [CarouselView.|<containerId>_carouselView.]frametransition=none|fade|slide[, *`期間`*[, *`間隔`*]`

<table id="table_D5992FCFF26046079089652B211BB6C5"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> none|フェード|スライド </span> </p> </td> 
   <td colname="col2"> <p>フレーム変更に適用されるエフェクトのタイプを指定します。 例えば、<span class="codeph"> none </span>はトランジションを表しません。フレームの変更は即座に行われます。 そして， </p> <p> <span class="codeph"> フェード </span>は、古いフレームと新しいフレームの間のクロスフェード移行を意味します。 最後に， </p> <p> <span class="codeph"> スライド </span>は、古いフレームがビューからスライドし、新しいフレームがスライドするトランジションをアクティブにします。 </p> </td> 
  </tr> 
  <tr> 
