...
SDK APIを使用する場合、[ビューアSDKの名前空間](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-namespace.md#concept-679bfabb3e3e4c12a285c4e9c4144153)で説明されているとおり、正しい完全修飾SDK名前空間を使用することが重要です。
