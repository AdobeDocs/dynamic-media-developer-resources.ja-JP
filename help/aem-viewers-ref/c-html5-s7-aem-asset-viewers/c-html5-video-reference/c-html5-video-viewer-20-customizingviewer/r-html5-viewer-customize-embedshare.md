...
TQID: 'https://experienceleague.adobe.com/9q5b5QHvqpr2APewYZZVf34gEMrQ2vSFvrpcLDlby5g'
product_v2:
...
例 – パディング付きのダイアログヘッダーを設定するには、24 x 14 ピクセルのアイコン、太字の16 ポイントタイトルを指定します。 最後に、28 x 28 ピクセルの「閉じる」ボタンを使用して、上から2 ピクセル、ダイアログボックスコンテナの右から2 ピクセルの位置に配置します。
...
>[!NOTE]
>
>キャンセルボタンでは、`state`属性セレクターをサポートしています。このセレクターを使用すると、異なるスキンを異なるボタンの状態に適用できます。
...
ダイアログボックスラベルツールのヒントはローカライズできます。 詳しくは、[&#x200B; ユーザーインターフェイス要素のローカライゼーション &#x200B;](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)を参照してください。
...
例 – 「ドロップダウン」ボタンを28 x 28 ピクセルに設定し、各状態に個別の画像を設定するには、次の手順を実行します。
