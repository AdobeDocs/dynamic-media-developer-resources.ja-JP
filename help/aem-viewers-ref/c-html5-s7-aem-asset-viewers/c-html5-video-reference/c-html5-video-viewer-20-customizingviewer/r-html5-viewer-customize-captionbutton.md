...
TQID: 'https://experienceleague.adobe.com/bM4IQTfvY11le25kdRkcxF7Lff-bAnB8X9YY--x-NTA'
product_v2:
...
コントロールバーの上端から4 ピクセル、右端から68 ピクセルに位置する28×28 ピクセルのクローズドキャプションボタンを設定する。 最後に、選択または選択されていない4つの異なるボタンの状態ごとに異なる画像が表示されます。
