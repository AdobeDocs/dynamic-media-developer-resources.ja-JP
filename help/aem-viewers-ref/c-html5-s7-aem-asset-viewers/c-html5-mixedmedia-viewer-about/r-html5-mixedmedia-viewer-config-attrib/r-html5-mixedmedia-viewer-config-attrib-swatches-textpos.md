...
TQID: 'https://experienceleague.adobe.com/nTsGRHxTVN07P0zvTJ3oU81S6lMWmTWAtpOD8suaV-M'
...
<table id="table_B3B03B00DCF0466DB332E851F4DDF610"> 
 <tbody> 
  <tr> 
   ...
   <td> <p> スウォッチのサムネール画像を基準にしてラベルを描画する場所を指定します。 つまり、ラベルは、スウォッチのサムネールを基準とした指定された場所に中央に配置されます。 <span class="codeph"> ツールチップ </span>が指定されている場合、ラベルは描画されません。 </p> </td> 
  </tr> 
 </tbody> 
</table>
