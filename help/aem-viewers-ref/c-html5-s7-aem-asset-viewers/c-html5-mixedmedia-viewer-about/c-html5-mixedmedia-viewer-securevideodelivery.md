...
「[&#x200B; （URLをWeb アプリケーションにリンクする](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/linking-urls-to-yourwebapplication.html?lang=ja#dynamic)」も参照してください。
