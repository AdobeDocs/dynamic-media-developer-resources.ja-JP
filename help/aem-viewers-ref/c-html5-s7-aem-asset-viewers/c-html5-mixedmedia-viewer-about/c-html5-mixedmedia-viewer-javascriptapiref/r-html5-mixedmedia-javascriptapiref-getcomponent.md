...
SDK APIを使用する場合は、ユーザーインターフェイス要素のローカリゼーションで説明されている、正しい完全修飾SDK名 [前空間を使用することが重要です](../../../c-html5-s7-aem-asset-viewers/c-html5-mixedmedia-viewer-about/c-html5-mixedmedia-viewer-localization.md#concept-16262b8096474d6c9c018c3e99110dd1)。
