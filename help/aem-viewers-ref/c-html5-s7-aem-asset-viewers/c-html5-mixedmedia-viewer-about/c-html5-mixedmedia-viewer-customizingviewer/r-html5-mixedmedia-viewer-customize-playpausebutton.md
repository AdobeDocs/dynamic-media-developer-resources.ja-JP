---
title: 再生/一時停止ボタン
description: 再生/一時停止ボタンを使用すると、ユーザーが選択したビデオコンテンツをビデオプレーヤーで再生または一時停止できます。
...
再生/一時停止ボタンをクリックすると、ユーザーが選択したビデオコンテンツをビデオプレーヤーで再生または一時停止できます。
...
>
>`replay='true'` この属性は、ビデオが終了に達し、ボタンを選択すると最初から再生が再開されたときに設定されます。
...
32 x 32 ピクセルの再生/一時停止ボタンを、コントロールバーの上端と左端から 6 ピクセルの位置に設定します。 最後に、は、選択または未選択の場合、4 つの異なるボタン状態ごとに異なる画像を表示します。
