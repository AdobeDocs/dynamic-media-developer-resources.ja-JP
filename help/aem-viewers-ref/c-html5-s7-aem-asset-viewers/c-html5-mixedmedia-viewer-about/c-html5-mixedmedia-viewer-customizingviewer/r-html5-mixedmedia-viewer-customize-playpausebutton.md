---
title: 再生/一時停止ボタン
description: 再生/一時停止ボタンを使用すると、ユーザーがビデオコンテンツを選択したときに、ビデオプレーヤーがビデオコンテンツを再生または一時停止します。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,Mixed Media Sets
role: Developer,User
exl-id: 8312645f-5704-499f-b66a-cf51dd8c1ec7
TQID: 'https://experienceleague.adobe.com/wXghuIL-aX0EVqaCEdve5Zir-7-AIS769Sd5kKS5X-M'
...
再生/一時停止ボタンを使用すると、ユーザーがビデオコンテンツを選択したときに、ビデオプレーヤーがビデオコンテンツを再生または一時停止します。
...
>
>`replay='true'`この属性は、ビデオが最後に達し、ボタンを選択すると最初から再生が再開される場合に設定されます。
...
再生/一時停止ボタンを32 x 32 ピクセルに設定し、コントロールバーの上端と左端から6 ピクセルに配置する。 最後に、選択または選択されていない4つの異なるボタンの状態ごとに異なる画像が表示されます。
