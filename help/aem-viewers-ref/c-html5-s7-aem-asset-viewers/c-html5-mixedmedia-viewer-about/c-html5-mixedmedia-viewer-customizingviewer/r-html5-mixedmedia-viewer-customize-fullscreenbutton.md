---
title: フルスクリーンボタン
description: このボタンは、ユーザーが選択した場合に、ビューアがフルスクリーンモードに入るか終了するかを示します。 ビューアが画像またはスピンセットを表示する場合に使用します。 ビューアがポップアップモードで動作し、システムがネイティブのフルスクリーンをサポートしていない場合、このボタンは表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,Mixed Media Sets
role: Developer,User
exl-id: 1df99614-9493-4c8a-bc51-4426b8c5467a
TQID: 'https://experienceleague.adobe.com/yW-fBfI-ZNLd3XuOyD93QjKfS7U-7u1FHqmrNajIDvg'
...
このボタンは、ユーザーが選択した場合に、ビューアがフルスクリーンモードに入るか終了するかを示します。 ビューアが画像またはスピンセットを表示する場合に使用します。 ビューアがポップアップモードで動作し、システムがネイティブのフルスクリーンをサポートしていない場合、このボタンは表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
...
例 – 32 x 32 ピクセルで、ビューアの上端と右端から6 ピクセル配置されたフルスクリーンボタンを設定する場合。 最後に、選択または選択されていない4つの異なるボタンの状態ごとに異なる画像が表示されます。
