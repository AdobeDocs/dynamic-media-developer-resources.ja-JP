---
title: Flyout Viewer用JavaScript API リファレンス
description: Flyout ViewerのメインクラスはFlyoutViewerです。 s7viewers名前空間で宣言されます。 このJavaScript APIでは、この特定のクラスのコンストラクター、メソッド、コールバックについて説明します。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,Flyout
role: Developer,User
exl-id: 7f85f6d0-bcc8-4d9b-ae0b-6fb9e1e7f0da
TQID: 'https://experienceleague.adobe.com/Xg40DvHg40srB6-o8bmIoGppgwsoBTRom5RUVuOvXfk'
product_v2:
...
# Flyout Viewer用JavaScript API リファレンス{#javascript-api-reference-for-flyout-viewer}

Flyout ViewerのメインクラスはFlyoutViewerです。 s7viewers名前空間で宣言されます。 このJavaScript APIでは、この特定のクラスのコンストラクター、メソッド、コールバックについて説明します。

次のすべての例では、`<instance>`は、`s7viewers.FlyoutViewer` クラスからインスタンス化されたJavaScript ビューアオブジェクトの実際の名前を表します。

* [廃棄する](r-html5-flyout-viewer-20-javascriptapiref-dispose.md)
