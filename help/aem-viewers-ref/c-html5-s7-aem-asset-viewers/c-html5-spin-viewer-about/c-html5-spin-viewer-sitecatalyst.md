...
## 標準の追跡 {#section-d06145cfa2b9491bb485b599368d466e}
...
をサードパーティの分析システムと統合するには、 `trackEvent` viewer コールバックとプロセス `eventInfo` 必要に応じて、コールバック関数の引数。 次のコードは、このようなハンドラー関数の例です。
