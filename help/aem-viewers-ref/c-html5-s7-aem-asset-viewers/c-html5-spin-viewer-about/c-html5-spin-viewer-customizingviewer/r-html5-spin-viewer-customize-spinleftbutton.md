---
description: このボタンをクリックまたはタップすると、メインビューの画像が左方向にスピンします。 携帯電話では、画面サイズの制限を守るため、このボタンは表示されません。 また、複数次元のスピンセットを使用すると、このボタンは非表示になります。 CSSを使用して、ボタンのサイズ、スキン、位置を設定できます。
seo-description: このボタンをクリックまたはタップすると、メインビューの画像が左方向にスピンします。 携帯電話では、画面サイズの制限を守るため、このボタンは表示されません。 また、複数次元のスピンセットを使用すると、このボタンは非表示になります。 CSSを使用して、ボタンのサイズ、スキン、位置を設定できます。
seo-title: 左スピンボタン
...
このボタンをクリックまたはタップすると、メインビューの画像が左方向にスピンします。 携帯電話では、画面サイズの制限を守るため、このボタンは表示されません。 また、複数次元のスピンセットを使用すると、このボタンは非表示になります。 CSSを使用して、ボタンのサイズ、スキン、位置を設定できます。
