...
TQID: 'https://experienceleague.adobe.com/Rt-FzpL-SYqKPbUpVb--wUbt8a7ve9DPeko7qU2QVq8'
...
このボタンをクリックまたはタップすると、メインビューの画像がズームインします。 このボタンは、画面の不動産を保存するために携帯電話には表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
