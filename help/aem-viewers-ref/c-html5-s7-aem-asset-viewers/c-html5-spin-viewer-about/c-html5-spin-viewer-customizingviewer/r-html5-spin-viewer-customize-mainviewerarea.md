---
title: メインビューア領域
description: メインビュー領域は、スピン画像が表示される領域です。 通常、サイズが指定されていない場合は、使用可能なデバイス画面に収まるようにが設定されます。
...
メインビュー領域は、スピン画像が表示される領域です。 通常、サイズが指定されていない場合は、使用可能なデバイス画面に収まるようにが設定されます。
