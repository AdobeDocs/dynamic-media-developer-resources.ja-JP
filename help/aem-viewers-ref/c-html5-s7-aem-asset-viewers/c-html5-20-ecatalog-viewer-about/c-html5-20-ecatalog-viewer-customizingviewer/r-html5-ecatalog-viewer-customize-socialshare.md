...
TQID: 'https://experienceleague.adobe.com/DDmnYKwgL4JTxINXwBX-pE41hiFCjsIyx-x8LKp4gCw'
product_v2:
...
例 – ビューアコンテナの上部から4 ピクセル、右側から5 ピクセルに配置され、サイズが28 x 28のソーシャル共有ツールを設定するには、次の手順を実行します。
...
例 – 4つの異なるボタンの状態ごとに異なる画像を表示するソーシャル共有ツールボタンを設定するには：
