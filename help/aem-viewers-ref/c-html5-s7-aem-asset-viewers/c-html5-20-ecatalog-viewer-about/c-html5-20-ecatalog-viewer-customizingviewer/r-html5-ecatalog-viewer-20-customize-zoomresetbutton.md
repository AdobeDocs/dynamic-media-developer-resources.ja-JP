---
title: ズームリセットボタン
description: このボタンを選択またはタップすると、メインビューの画像がリセットされます。 このボタンは、デスクトップシステムとタブレットのメインコントロールバーに表示されます。 携帯電話では、このボタンは画像の下中央部分に表示されます。 ただし、画像がリセット状態の場合は表示されません。 このボタンのサイズ、スキンおよび位置は、CSS を使用して設定できます。
...
このボタンを選択またはタップすると、メインビューの画像がリセットされます。 このボタンは、デスクトップシステムとタブレットのメインコントロールバーに表示されます。 携帯電話では、このボタンは画像の下中央部分に表示されます。 ただし、画像がリセット状態の場合は表示されません。 このボタンのサイズ、スキンおよび位置は、CSS を使用して設定できます。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>メインコントロールバー（デスクトップおよびタブレット）またはビューア（携帯電話）の上部ボーダーから、パディングを含めて配置します。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> right </span> </p> </td> 
   <td colname="col2"> <p>メインコントロールバー（デスクトップおよびタブレット）またはビューア（携帯電話）の右端から、パディングを含めて配置します。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> left </span> </p> </td> 
   <td colname="col2"> <p>メインコントロールバー（デスクトップおよびタブレット）またはビューア（携帯電話）の左側のボーダーから、パディングを含めて配置します。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 下 </span> </p> </td> 
   <td colname="col2"> <p>メインコントロールバー（デスクトップおよびタブレット）またはビューア（携帯電話）の下部の境界線から、パディングを含めて配置します。 </p> </td> 
  </tr> 
  <tr> 
...
例 – ズームリセットボタンを設定します。28 x 28 ピクセルで、メインコントロールバーの下部から 4 ピクセル、右端から 47 ピクセル（デスクトップ上）に配置されます。 最後に、は、4 つの異なるボタン状態ごとに異なる画像を表示します。
