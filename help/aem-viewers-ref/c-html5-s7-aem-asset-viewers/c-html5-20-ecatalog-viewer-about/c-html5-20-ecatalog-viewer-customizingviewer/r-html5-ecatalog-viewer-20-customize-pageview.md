...
TQID: 'https://experienceleague.adobe.com/fybAsHxcg-v0Sc--RIzxIuQEFRnhSXv4MC50jWkff2c'
product_v2:
...
メインビューア領域の上にカスタムマウスカーソルを表示するように設定できます。 この機能は、`.s7ecatalogviewer .s7pageview` CSS クラスに適用された追加の属性セレクターで制御されます。
