...
TQID: 'https://experienceleague.adobe.com/ykrwhKSZJUxC00616wAtMsI7LHEpkI-iRuEsH-UgdsQ'
product_v2:
...
ビューに垂直方向に収まらないサムネールが存在する場合、サムネールは右側の垂直方向のスクロールバーをレンダリングします。 スクロールバー領域の外観は、次のCSS クラスセレクターで制御されます。
