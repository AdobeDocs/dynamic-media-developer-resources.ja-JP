...
SDK API を操作する場合は、「 [Viewer SDK の名前空間](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-html5-viewer-sdk-namespace.md#concept-16ce67bfbdc64ffc8fc7ad174f208f05).

詳しくは、 *ビューア SDK API* ドキュメントを参照してください。
