---
title: フルスクリーンボタン
description: ユーザーがクリックすると、ビューアがフルスクリーンモードに入るか、終了します。 このボタンは、ビューアがポップアップモードで動作し、システムがネイティブのフルスクリーンをサポートしていない場合は表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,Zoom
role: Developer,User
exl-id: ec8ebf24-c8ae-43f1-86b9-0b30d529d277
TQID: 'https://experienceleague.adobe.com/1BILV7JAfGIuTWrIBUIwDk5QCIWh-I4qHa6NtUyUfMU'
...
ユーザーが選択すると、ビューアがフルスクリーンモードに入るか、終了します。 このボタンは、ビューアがポップアップモードで動作し、システムがネイティブのフルスクリーンをサポートしていない場合は表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
...
例 – 32 x 32 ピクセルで、ビューアの上端と右端から6 ピクセル配置されたフルスクリーンボタンを設定します。 選択した場合と選択しなかった場合は、4つの異なるボタンの状態ごとに異なる画像を表示する必要があります。
