---
title: ズームリセットボタン
description: このボタンを選択すると、メインビューの画像がリセットされます。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,Zoom
role: Developer,User
exl-id: ced2bae0-3d26-46f3-92d9-6fb2830c7a23
TQID: 'https://experienceleague.adobe.com/XvEnrqfK7vcmWRNee-o-09iKbybhn9UM-Ia1JGZvwzY'
product_v2:
...
例 – 32 x 32 ピクセルで、ビューアの上端と右端から6 ピクセルに配置されたズームリセットボタンを設定します。 4つの異なるボタンの状態ごとに異なる画像を表示する必要があります。
