---
description: eCatalog Search Viewerでは、Adobe Analyticsのトラッキングをすぐにサポートしています。
...
eCatalog Search Viewerでは、Adobe Analyticsのトラッキングをすぐにサポートしています。

## すぐに利用できるトラッキング機能 {#section-ba994f079d0343c8ae48adffaa3195a3}

eCatalog Search Viewerは、標準のトラッキング機能[!DNL Adobe Analytics]をサポートしています。 トラッキングを有効にするには、適切な会社プリセット名を`config2` パラメーターとして渡します。
