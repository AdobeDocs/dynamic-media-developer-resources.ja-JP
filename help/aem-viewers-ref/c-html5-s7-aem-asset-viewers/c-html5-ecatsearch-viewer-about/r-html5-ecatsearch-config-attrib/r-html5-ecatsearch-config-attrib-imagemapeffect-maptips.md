...
TQID: 'https://experienceleague.adobe.com/LpXkQc7-5Q4FJ2jbtyNpkokwsmRJlJlhVzvfGgf-F1E'
product_v2:
...
<table id="table_3DBC5A70C9264CECA1CB3D1D08CEDF31"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> ツールヒントを個々のマップ領域エレメントに対して有効にするかどうかを指定します。 </p> <p> タッチ操作対応のデスクトップシステムを含むタッチデバイスでは無視されます。 </p> </td> 
  </tr> 
 </tbody> 
</table>
