---
description: このボタンをクリックまたはタップすると、カタログの最後のページに移動します。 このボタンは、デスクトップシステムおよびタブレットのメインコントロールバーに表示されます。携帯電話では、セカンダリコントロールバーに追加されます。 CSSを使用して、このボタンのサイズ設定、スキン表示、位置設定を行うことができます。
