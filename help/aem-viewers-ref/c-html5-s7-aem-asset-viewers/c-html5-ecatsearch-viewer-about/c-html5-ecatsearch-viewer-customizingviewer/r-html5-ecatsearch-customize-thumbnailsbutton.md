---
title: 「サムネール」ボタン
description: このボタンを選択すると、メインビューとサムネールの間でビューアが切り替わります。 このボタンは、メインコントロールバーに表示されます。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,eCatalog Search
role: Developer,User
exl-id: 465d4320-14ea-4f07-97c0-41f53034a7df
TQID: 'https://experienceleague.adobe.com/AW3lnolX7gPbB7uDywu6Ne0t0cf1kkr1jynYupUeZPY'
...
このボタンを選択すると、メインビューとサムネールの間でビューアが切り替わります。 このボタンは、メインコントロールバーに表示されます。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
...
例 – 28 x 28 ピクセルのサムネールボタンを設定し、メインコントロールバーの左端から4 ピクセル、左端から5 ピクセルの位置に配置する。 最後に、選択または選択されていない4つの異なるボタンの状態ごとに異なる画像が表示されます。
