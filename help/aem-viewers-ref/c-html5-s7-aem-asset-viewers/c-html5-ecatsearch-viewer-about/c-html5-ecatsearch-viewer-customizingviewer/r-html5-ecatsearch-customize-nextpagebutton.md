...
TQID: 'https://experienceleague.adobe.com/3qOCJaJs3huicy7sLSoGIQ9dff-VtBom3LM8WLUkETU'
product_v2:
...
例 – 次のページボタンを設定するには、28 x 28 ピクセルで、下部から4 ピクセル、メインコントロールバーの右端から250 ピクセルに配置します。 最後に、4つの異なるボタンの状態ごとに異なる画像が表示されます。
