---
title: ズームリセットボタン
description: このボタンを選択すると、メインビューの画像がリセットされます。 このボタンは、デスクトップシステムとタブレットのメインコントロールバーに表示されます。 携帯電話では、このボタンは画像の上の下部中央に表示されます。 ただし、画像がリセット状態の場合は表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,eCatalog Search
role: Developer,User
exl-id: d5aa9e9d-4d7e-428c-a43f-d2b4c9e59777
TQID: 'https://experienceleague.adobe.com/Fb06LfRnbEH9-eaUxxAeAqMZcqcb5aKdnt9SmGjQOp4'
product_v2:
...
このボタンを選択すると、メインビューの画像がリセットされます。 このボタンは、デスクトップシステムとタブレットのメインコントロールバーに表示されます。 携帯電話では、このボタンは画像の上の下部中央に表示されます。 ただし、画像がリセット状態の場合は表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>メインコントロールバー（デスクトップやタブレット上）またはパディングを含むビューア（携帯電話上）の上端からの位置。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph">右</span> </p> </td> 
   <td colname="col2"> <p>メインコントロールバー（デスクトップやタブレット）またはパディングを含むビューア（携帯電話）の右端からの位置。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph">さんが</span>を残しました </p> </td> 
   <td colname="col2"> <p>メインコントロールバーの左端（デスクトップやタブレット）またはパディングを含むビューア（携帯電話）の左端からの位置。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph">下</span> </p> </td> 
   <td colname="col2"> <p>メインコントロールバー（デスクトップやタブレット）またはパディングを含むビューア（携帯電話）の下部境界からの位置。 </p> </td> 
  </tr> 
  <tr> 
...
例 – 28 x 28 ピクセルで、下部から4 ピクセル、メインコントロールバーの右端から47 ピクセルに配置されたズームリセットボタンを設定する。 最後に、4つの異なるボタンの状態ごとに異なる画像が表示されます。
