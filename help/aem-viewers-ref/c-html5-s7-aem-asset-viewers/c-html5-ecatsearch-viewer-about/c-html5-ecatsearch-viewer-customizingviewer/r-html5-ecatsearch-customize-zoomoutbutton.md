---
title: ズームアウトボタン
description: このボタンを選択すると、メインビューの画像がズームアウトします。 このボタンは、画面の不動産を保存するために携帯電話には表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,eCatalog Search
role: Developer,User
exl-id: a4c2eb32-819c-45a1-ac03-44e78ebd042b
TQID: 'https://experienceleague.adobe.com/F8Rr-y24ZZAFFFUmGYpFxtthxur0Tuf3VrxPyUFlqB4'
...
このボタンを選択すると、メインビューの画像がズームアウトします。 このボタンは、画面の不動産を保存するために携帯電話には表示されません。 CSSを使用して、このボタンのサイズ、肌、位置を調整できます。
...
例 – 28 x 28 ピクセルで、メインコントロールバーの下端から4 ピクセル、右端から75 ピクセルに配置されたズームアウトボタンを設定する。 最後に、4つの異なるボタンの状態ごとに異なる画像が表示されます。
