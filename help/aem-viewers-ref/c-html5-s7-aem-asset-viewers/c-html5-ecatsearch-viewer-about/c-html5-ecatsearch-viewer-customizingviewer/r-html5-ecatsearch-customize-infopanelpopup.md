...
例 — 300 x 200 ピクセルの情報パネルダイアログをビューア領域の中央に配置する設定には、上部に 40 ピクセルのパディング、その他すべての辺に 10 ピクセルのパディング、ライトグレーの背景、10 ピクセルの境界線の半径とドロップシャドウがあります。
...
例 — 28 x 28 ピクセルで、情報パネルダイアログの上端と右端から 5 ピクセルの位置に配置し、ボタンの 4 つの状態ごとに異なる画像を表示するダイアログ閉じるボタンを設定します。
