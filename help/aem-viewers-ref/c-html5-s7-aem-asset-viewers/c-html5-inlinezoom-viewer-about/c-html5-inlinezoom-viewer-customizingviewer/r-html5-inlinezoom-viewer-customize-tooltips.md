...
TQID: 'https://experienceleague.adobe.com/v7xCSMIm8Z0JmGM5ncpnGKi6--OZ6l5axgQdTWSFHts'
product_v2:
...
>[!NOTE]
>
>ツールチップのスタイルを埋め込みweb ページ内からカスタマイズする場合、すべてのプロパティに`!IMPORTANT` ルールを含める必要があります。 ただし、ツールヒントがビューアのCSS ファイルでカスタマイズされている場合は必要ありません。
