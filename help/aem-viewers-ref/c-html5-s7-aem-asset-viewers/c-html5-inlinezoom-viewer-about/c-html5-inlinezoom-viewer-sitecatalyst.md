...
description: フライアウトビューアは、標準搭載のAdobe Analytics トラッキングをサポートしています。
...
フライアウトビューアは、標準搭載のAdobe Analytics トラッキングをサポートしています。

## すぐに利用できるトラッキング機能 {#section-ba994f079d0343c8ae48adffaa3195a3}

インラインズームビューアは、標準で[!DNL Adobe Analytics]追跡をサポートしています。 トラッキングを有効にするには、適切な会社プリセット名を`config2` パラメーターとして渡します。
