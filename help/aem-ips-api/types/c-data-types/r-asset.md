...
<table id="table_C58EF9963CB34179A9D6C9F0F6FF24F2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> キャビネット資産タイプのプロパティ。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> の種類：CssInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">仮想ファイル名を返します。 仮想ファイルの完全なパスは <span class="codeph"> folder</span>+<span class="codeph"> fileName</span> です。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> フ <span class="codeph"> ントの種類：fontInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> タイプ：MetadataArray</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> レンダーシーン アセットのプロパティ。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">サブタイプの値をサポートする汎用のアセットサブタイプ（例：<span class="codeph"> AssetSet</span>）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> アセットがゴミ箱またはライブのどちらにあるかを示します（値については「ごみ箱の状態」を参照）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> の種類：VideoCaptionInfo</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> の種類：VignetteInfo</span> </td> 
   <td colname="col3"> ビネットアセットのプロパティ。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL watermarkInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> の種類：WatermarkInfo</span> </td> 
