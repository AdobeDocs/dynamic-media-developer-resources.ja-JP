...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <span class="codeph"> 元の <span class="varname"> パス</span></span> </td> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> 最適 <span class="varname"> 化ファイル</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> 解 <span class="varname"> 像</span></span> </td> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> コメ <span class="varname"> ント</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> アン <span class="varname"> カー</span> X </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:int</span> </td> 
   <td colname="col3"> <p>水平方向のアンカーポイント（ピクセル単位）。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> アン <span class="varname"> カー</span> Y </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:int</span> </td> 
   <td colname="col3"> <p>ピクセル内の垂直方向のアンカーポイント。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> url修飾子</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>Image ServerのURLパラメータ。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> urlPostApplyModifier</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>urlModifierの末尾に連結されたパラメ <span class="codeph"> ータ</span>。 Image Serverに対するコマンドであるパラメータのクエリ文字列形式のリスト。 値は、Image Serverのプロトコルガイドに記載されています。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> zoomTargets <span class="varname"></span></span> </td> 
   <td colname="col2"> <span class="codeph"> タイプ：ZoomTargetArray</span> </td> 
   <td colname="col3"> <p>ズームターゲットの配列（最大5個） </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> マス <span class="varname"> ク</span></span> </td> 
   <td colname="col2"> <span class="codeph"> 型：MaskArray</span> </td> 
   <td colname="col3"> <p>マスク配列 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> 画 <span class="varname"> 像マップ</span></span> </td> 
   <td colname="col2"> <span class="codeph"> タイプ：ImageMapsArray</span> </td> 
