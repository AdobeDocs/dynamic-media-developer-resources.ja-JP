...
seo-description: searchAssetsで使用する検索語句を追加します。
...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> ブール値の比較値（ブール型フィールドのみ）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:long</span> </td> 
   <td colname="col3"> 範囲比較の最大long値（整数型フィールドのみ）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:double</span> </td> 
   <td colname="col3"> 範囲比較の最小倍精度値（浮動小数点型フィールドのみ）。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> maxDouble</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:double</span> </td> 
   <td colname="col3"> 範囲比較の最大倍精度値（浮動小数点型フィールドのみ）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> 大文字と <span class="varname"> 小文字</span></span> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> メタデータサーバの大文字と小文字の区別を設定します。 searchAssetsByMetadataの呼び出しで使 <span class="codeph"> 用されます</span> 。 </p> <p>searchAssetsByMetadataを参照し <a href="../../operations/c-operations-intro/c-methods/r-search-assets-by-metadata.md#reference-609ec73944a34ce49b152389fbb40414" format="dita" scope="local"> てください</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
