...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">次に設定： 
    <ul id="ul_BD8686943BD14D05A21C00192D4D70D3"> 
     <li id="li_B6A6DE5AAEFF4A80A8413B4785A88222"><span class="codeph"> True</span>:指定したフォルダとすべてのサブフォルダを検索するには </li> 
  ...
  <tr> 
   ...
   <td colname="col3">検索で返すアセットタイプのリストです。 例： <span class="codeph"> 画像</span>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> type:StringArray</span> </td> 
   <td colname="col3">検索で返すアセットサブタイプのリスト。 例えば、 <span class="codeph"> AssetSet</span>を検索する場合、 <span class="codeph"> MediaType</span> サブタイプ。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"><span class="varname"> strictSubTypeCheck</span></span> </td> 
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>サブタイプのないアセットを返すかどうかを指定する（オプション）ブール型フラグ ( <span class="codeph"> assetSubTypeArray</span> が渡された。 </p> <p>true の場合は、指定されたサブタイプの 1 つを持つアセットのみが返されます。 </p> <p>false の場合は、サブタイプのないアセットも返されます。 </p> <p>デフォルトは false です。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3">次に設定： 
    <ul id="ul_8C164A5D9F0F43968C86A67FA6884F35"> 
     ...
     <li id="li_4970226BF0FF42388CAE4415FB63AF16"><span class="codeph"> False</span>:生成されたコンテンツを返す。 例えば、アップロードされた画像からのPDF。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">指定する: 
    ...
    </ul> <p>注意：検索するには空白のままにします <i>すべて</i> 公開済みの状態のタイプ。 </p> </td> 
  </tr> 
  <tr> 
