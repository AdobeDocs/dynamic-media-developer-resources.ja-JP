...
TQID: 'https://experienceleague.adobe.com/ql0YcFNTDsoetEyZEBtpCfJFnAwRknmlsEiOr-PSsxQ'
product_v2:
...
| permissionType | `xsd:string` | 権限の種類： |
| isAllowed | `xsd:boolean` | 権限の更新が許可されているかどうかを指定します。 |
