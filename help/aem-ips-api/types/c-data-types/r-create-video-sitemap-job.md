...
<table id="table_7B459A9D55CE49A38D8A77CBD229033A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"><span class="codeph"> true</span>に設定すると、サイトマップを生成します。 <p><p>注意：サイトマップ生成設定が手動に設定されていて<span class="codeph"> forceUpdate</span>が設定されていない場合、サイトマップは生成されません。 </p></p></td> 
  </tr> 
 </tbody> 
</table>
