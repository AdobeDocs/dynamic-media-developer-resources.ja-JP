...
<table id="table_6E40A78846F444BDB8E437413B90CFCE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>自動画像切り抜きオプション（色に基づく） </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>ファイルの IPS フォルダ。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>ビデオからサムネール画像を設定できるオプション。 </p> <p>詳しくは、 <a href="../../types/c-data-types/r-media-options.md#reference-18618fc6803a4b6e994bbb48eba93b5b" format="dita" scope="local"> MediaOptions</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Post スクリプトファイルを Image Server にアップロードするためのオプションです。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>既存の切り抜き定義の保存を制御します。 デフォルトは true です。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>このジョブに対して個別のメタデータ XML ファイルを処理するかどうか。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>ファイルが公開準備完了とマークされているかどうかを指定します。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>アップロードした TAR/ZIP ファイルの内容を、以下のオプション設定で抽出して処理します。 </p> <p>詳しくは、 <a href="../../types/c-data-types/r-uncompress-options.md#reference-510ec7028b1540bc9b58745f242d49d5" format="dita" scope="local"> UnCompressOptions</a>. </p> </td> 
  </tr> 
  <tr> 
