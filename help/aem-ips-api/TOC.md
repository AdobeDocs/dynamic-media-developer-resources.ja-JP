...
user-guide-description: IPS （Image Production System） web サービス API を使用すると、外部のアプリケーションやサードパーティの開発者が、IPS のアセットや機能にプログラムでアクセスできます。
...
+ 操作方法 {#operation-methods}
   ...
   + 操作パラメーター {#operation-parameters}
      ...
      + [addGroupMembers](operations/c-operations-intro/c-methods/r-add-group-membership.md)
      ...
      + [getActiveJob](operations/c-operations-intro/c-methods/r-get-active-jobs.md)
      ...
      + [getAutoCropDirect](operations/c-operations-intro/c-methods/r-get-auto-crop-rect.md)
      ...
      + [getGroupMembers](operations/c-operations-intro/c-methods/r-get-group-membership.md)
      ...
      + [getJobLog](operations/c-operations-intro/c-methods/r-get-job-logs.md)
      ...
      + [getSearchString](operations/c-operations-intro/c-methods/r-get-search-strings.md)
      ...
      + [getUserChar](operations/c-operations-intro/c-methods/r-get-user-chars.md)
      ...
      + [getVistaPublishFormats](operations/c-operations-intro/c-methods/r-get-vignette-publish-formats.md)
      ...
      + [setCompanyMembers](operations/c-operations-intro/c-methods/r-set-company-membership.md)
...
+ データタイプ {#data-types}
   ...
   + [会社のメンバーシップ](types/c-data-types/r-company-membership.md)
   ...
   + [ConfigSettings](types/c-data-types/r-config-setting.md)
   ...
   + [ディスク使用量](types/c-data-types/r-disk-usage.md)
   ...
   + [SearchString](types/c-data-types/r-search-strings.md)
   ...
   + [タスク進行状況配列](types/c-data-types/r-task-progress-array.md)
   ...
   + [アンシャープマスクオプション](types/c-data-types/r-unsharp-mask-options.md)
   ...
   + [郵便番号](types/c-data-types/r-zip-entry.md)
...
+ 文字列定数 {#sting-constants}
   ...
   + [アセット並べ替えフィールド](string-constants/c-string-constants/r-asset-sort-fields.md)
   + [アセットタイプ](string-constants/c-string-constants/r-asset-types.md)
   + [コーナーを自動切り抜き](string-constants/c-string-constants/r-auto-crop-corner.md)
...
+ [HTTP POST を使用して UploadFile にアセットをアップロードしています…](c-http-post.md)
