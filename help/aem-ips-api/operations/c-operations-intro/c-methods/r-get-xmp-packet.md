---
description: 指定されたアセットのXMP Metadataパケットを取得します。
...
指定されたアセットのXMP Metadataパケットを取得します。

構文

## 許可されたユーザーの種類 {#section-7cb9c26045214f01b1d6b6948b6c6a18}
...
| 名前 | 種類 | 必須 | 説明 |
|---|---|---|---|
| `*`companyHandle`*` | `xsd:string` | はい | 会社は、返すパケット（`c|656`など）を処理します。 |
