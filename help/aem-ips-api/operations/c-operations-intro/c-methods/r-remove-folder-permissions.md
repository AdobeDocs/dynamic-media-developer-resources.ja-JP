...
## 承認済みユーザータイプ {#section-bfa745624f9b43aaba6c226ac6700fe7}
  ...
  <tr> 
   ...
   <td colname="col4"> <p><span class="codeph"> true</span>の場合： 
     ...
     <ul id="ul_19AEE80F1FC84B64AD623E050C12A0CD"> 
      <li id="li_B8B78851004C43DB8CB7958E380AF510">操作は、指定したフォルダーにのみ影響します。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
このコードのサンプルでは、フォルダーとそのサブフォルダーから権限を削除します。 `updateChildren`を`false`に設定して、親フォルダーからのみ権限を削除します。
