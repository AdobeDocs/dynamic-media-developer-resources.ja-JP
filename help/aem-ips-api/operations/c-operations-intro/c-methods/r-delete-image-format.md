...
## 認証されたユーザータイプ {#section-827e24a3019543418b0a635d46c1edfd}
...
| 名前 | 種類 | 必須 | 説明 |
|---|---|---|---|
| ` *`companyHandle`*` | `xsd:string` | はい | 削除する画像形式を含む会社のハンドル。 |
...
このコードサンプルを使用すると、会社から画像形式を削除できます。 別の操作から画像形式のハンドルを取得します。
