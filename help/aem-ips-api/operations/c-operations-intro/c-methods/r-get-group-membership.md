...
seo-description: グループのメンバーを返します。
...
## 認証されたユーザータイプ {#section-35d070e5c4d74ca69df508368953cfb8}
...
このコード例は、グループのすべてのメンバーを返します。 会社とユーザーのハンドルはオプションなので、この操作ではすべてのグループのすべてのメンバーを返すことができます。
