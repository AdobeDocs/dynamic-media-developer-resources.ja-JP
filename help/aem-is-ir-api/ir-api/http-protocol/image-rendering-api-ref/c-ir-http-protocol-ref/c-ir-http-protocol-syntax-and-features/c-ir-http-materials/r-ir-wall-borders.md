---
description: マテリアルは、壁の境界MSS（sub=3..5で導入）で指定される場合、壁の境界と見なされます。
seo-description: マテリアルは、壁の境界MSS（sub=3..5で導入）で指定される場合、壁の境界と見なされます。
seo-title: 壁の境界
...
マテリアルは、壁の境界MSS（sub=3..5で導入）で指定される場合、壁の境界と見なされます。
