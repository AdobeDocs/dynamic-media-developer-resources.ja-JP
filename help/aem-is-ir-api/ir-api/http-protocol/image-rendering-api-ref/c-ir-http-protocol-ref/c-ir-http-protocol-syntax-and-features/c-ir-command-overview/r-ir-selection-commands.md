---
title: 選択コマンド
description: これらのコマンドは、ビネットグループ、オブジェクト、グループまたはオブジェクトのサブエリアを選択するために使用されます。
...
これらのコマンドは、ビネットグループ、オブジェクト、グループまたはオブジェクトのサブエリアを選択するために使用されます。

この選択コマンドの後、次の選択コマンド（または要求の終わり）が選択された項目に適用される前に、コマンド、マテリアル、またはその両方が指定されます。 選択コマンドは、材料仕様セグメント（MSS）を区切ります。
...
<table id="simpletable_028957E516644FE8A7B1BC056A32FCD1"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ピクセル位置でビネット グループまたはオブジェクトを選択します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-decal.md#reference-3a5f1adc7fe24c91aa5655d64038e857" type="reference" format="dita" scope="local"> デカル転写 </a></span> </p></td> 
  <td class="stentry"> <p>選択したオブジェクトのデカル転写エリアを選択します。 </p></td> 
 </tr> 
 <tr class="strow"> 
