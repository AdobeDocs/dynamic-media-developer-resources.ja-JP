---
title: 属性を表示
description: これらのコマンドは、位置に依存せず、リクエスト内のどこでも使用できます。
...
これらのコマンドは、位置に依存せず、リクエスト内のどこでも使用できます。
...
<table id="simpletable_D30C7420AECD44ADBD7B0728594FF5FA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>JPEGの品質。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>返信画像に埋め込まれた印刷解像度の値。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>指定した高さにレンダリング イメージを尺度変更します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>指定した幅にレンダリング イメージを拡大/縮小します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>フル解像度のビネットサイズを基準にして、レンダリングしたイメージの尺度を変更します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>最終的な画像の拡大縮小のための再サンプリングモード。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"><a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharpen.md#reference-13034d22d176483cb99ccafc2a4f6a6e" type="reference" format="dita" scope="local"> 削る </a></span> </p></td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-vignette.md#reference-eb3f458733294f988483b024348bc778" type="reference" format="dita" scope="local"> ヴィネット </a></span> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>デフォルトの応答キャッシュ動作をオーバーライドします。 </p></td> 
 </tr> 
</table>
