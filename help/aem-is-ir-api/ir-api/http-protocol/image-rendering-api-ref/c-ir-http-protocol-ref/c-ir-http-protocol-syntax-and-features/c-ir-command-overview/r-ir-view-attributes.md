---
description: これらのコマンドは位置に依存せず、リクエストのどこでも使用できます。
seo-description: これらのコマンドは位置に依存せず、リクエストのどこでも使用できます。
seo-title: 表示属性
...
# 表示属性{#view-attributes}

これらのコマンドは位置に依存せず、リクエストのどこでも使用できます。
...
<table id="simpletable_D30C7420AECD44ADBD7B0728594FF5FA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>返信画像形式。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>返信画像に埋め込まれるプリント解像度の値。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>最大解像度のビネットサイズを基準にして、レンダリングイメージを拡大・縮小します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>返信画像にPhotoshopパスを埋め込みます。 </p></td> 
 </tr> 
 <tr class="strow"> 
