---
title: 属性を表示
description: これらのコマンドは位置に依存せず、リクエストの任意の場所で発生する可能性があります。
solution: Experience Manager
feature: Dynamic Media Classic,SDK/API
role: Developer,User
exl-id: 18e1ee40-fe34-435a-be97-849b08618d48
TQID: 'https://experienceleague.adobe.com/iHjv-kWDAlH4682dCAm7NXO78-0ZyI0mihQoIxWL60Q'
...
これらのコマンドは位置に依存せず、リクエストの任意の場所で発生する可能性があります。
...
<table id="simpletable_D30C7420AECD44ADBD7B0728594FF5FA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>返信画像に埋め込まれた解像度の値を印刷します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レンダリングした画像を指定した高さに拡大・縮小します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レンダリングした画像を指定した幅に拡大・縮小します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>フル解像度の周辺光量補正サイズを基準に、レンダリングした画像を拡大・縮小します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>最終的な画像の拡大・縮小のための再サンプリングモード。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharpen.md#reference-13034d22d176483cb99ccafc2a4f6a6e" type="reference" format="dita" scope="local"> シャープ </a></span> </p></td> 
  <td class="stentry"> <p>返信の画像シャープニング。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>周辺光量補正： </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>デフォルトのレスポンシブキャッシュ動作を上書きします。 </p></td> 
 </tr> 
</table>
