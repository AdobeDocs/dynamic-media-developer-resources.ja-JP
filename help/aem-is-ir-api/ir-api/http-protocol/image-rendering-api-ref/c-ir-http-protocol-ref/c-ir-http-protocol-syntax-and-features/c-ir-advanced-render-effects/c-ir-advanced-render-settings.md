---
title: レンダリングの詳細設定
description: ビネットオーサリングツール (Dynamic Media Image Authoring パッケージの一部 ) は、ビネットレンダーエンジンの低レベルの側面を制御するメカニズムを提供します。
...
## レンダリングの詳細設定 (rs=) 値 {#section-d9e7f341ebd44f07a4e90f1f5910726b}
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>レンダリングエフェクト/代替シェーダ (Render Effects/Alternate Shader) は、ビネットの設定をオーバーライドします。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>USM を使用するには、0 より大きい値を指定する必要があります </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>USM しきい値（レベル）。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      <li id="li_E7711C3678ED4DE09E710F7C430CEF42">最寄りの隣人 </li> 
      ...
      <li id="li_34EC85C4D15145DF80F7D3DB7B6244D3">ランコス窓 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_FD4A9D73C32F47C3BF13776BB4D2818D"> 
      ...
      <li id="li_FD4C859D975B44399475D4D93D6B05AB">最寄りの隣人 </li> 
      ...
      <li id="li_6E9D81045A0C4804A4D35D9B239F6486">ポアソンサンプラー </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"><b>レンダリングエフェクト（古いシェーダ）</b> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> </td> 
   <td colname="col5"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>光沢に基づく外挿強度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>明るさ補正（チェックボックス） </p> </td> 
   <td colname="col3"> <p> </p> </td> 
   <td colname="col4"> <p> </p> </td> 
   <td colname="col5"> <p>初期設定は on （空白）で、選択解除はF100G0 です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：a36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：b36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：c36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>d </p> </td> 
   <td colname="col2"> <p>調整をハイライトします。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：d36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：e36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：k64.138.175.60.xx.133.242 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：u8.1.2.3.4.5.6.7.8.s8.1.2.3.4.5.6.7.8. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>異なる形式：v8.1.2.3.4.5.6.7.8.t8.1.2.3.4.5.6.7.8. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>w </p> </td> 
   <td colname="col2"> <p>彩度の調整。 </p> </td> 
...
<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>構成を設定中 </p> </th> 
   <th colname="col2" class="entry"> <p>説明 </p> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>画像オーサリングのデフォルト値。 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_949B6DB4959B46A892787CD5B3AD7485">W100 = USM 量 (1%～500%) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C6E6DD90ECAB4D2B9284A25A29923DC6"> 
      ...
      <li id="li_A003B68023424DCABBF3A2CAF98C39A4">最大および明るさの補正がすべてオンです。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>シャープ付き代替シェーダ： </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">再サンプリング（スーパーサンプリング、ランダム=ハーフ、レート=ハーフ） </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">コントラスト（強） </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">彩度の調整（中央の 1 つ目の頂点、エッジの 2 つ目の頂点、3 つ目の頂点の中点の低さ） </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">シャープ（3/4 方向右） </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
