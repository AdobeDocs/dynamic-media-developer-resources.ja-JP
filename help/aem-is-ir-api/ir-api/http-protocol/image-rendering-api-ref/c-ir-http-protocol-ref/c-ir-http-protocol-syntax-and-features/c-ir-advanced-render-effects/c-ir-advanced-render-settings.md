---
title: レンダーの詳細設定
description: 周辺光量補正オーサリングツール（Dynamic Media画像オーサリングパッケージの一部）は、周辺光量補正レンダリングエンジンの低レベルの側面を制御するメカニズムを提供します。
...
# レンダーの詳細設定{#advanced-render-settings}

周辺光量補正オーサリングツール（Dynamic Media画像オーサリングパッケージの一部）は、周辺光量補正レンダリングエンジンの低レベルの側面を制御するメカニズムを提供します。

>[!NOTE]
>
>レンダリング設定は、画像レンダリングと画像オーサリングの高度な機能です。 レンダリング設定の使用に関するトレーニング、コンサルテーション、またはその両方については、Adobe テクニカルサポートまたはAdobeのコンサルティング担当者にお問い合わせください。

これらの設定は、画像オーサリングでインタラクティブに制御されます。 画像レンダリングでは、`rs=` コマンドを使用して（または`catalog::RenderSettings`値を使用して）同じ設定を適用できます。 このメカニズムは、各マテリアルに対して異なるシャープニングオプションを選択し、ハイライトの彩度やシャドウのコントラストの変化など、イルミネーションのレンダリングアルゴリズムの動作を変更するために使用されます。
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>レンダーエフェクト/代替シェーダーは、周辺光量補正の設定をオーバーライドします。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>1 </p> </td> 
   <td colname="col5"> <p>A0=レンダーエフェクト </p> <p>A1=代替シェーダー </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col5"> <p>USMを使用するには、Uが&gt;0である必要があります </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>USM半径（ピクセル）。 </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      <li id="li_E7711C3678ED4DE09E710F7C430CEF42">最も近い隣人 </li> 
      <li id="li_CAE975B91C604DA0AA493F700AEBE199">バイリニア </li> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_FD4A9D73C32F47C3BF13776BB4D2818D"> 
      ...
      <li id="li_FD4C859D975B44399475D4D93D6B05AB">最も近い隣人 </li> 
      <li id="li_CA93566F5D4F4D3CAA1D0816562A3851">バイリニア </li> 
      <li id="li_D334ACF969E749A89A464B21C96CE8A6">スーパーサンプリング </li> 
      <li id="li_FAC72C36FF4A418F8A5B05F3B4E7C5D8">アダプティブ </li> 
      <li id="li_6E9D81045A0C4804A4D35D9B239F6486">ポアソン・Sampler </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>デフォルトは5です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>M </p> </td> 
   <td colname="col2"> <p>アダプティブサイズ変更：深度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poisson：サンプル/ピクセル。 </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
   <td colname="col4"> <p>4 </p> </td> 
   <td colname="col5"> <p>デフォルトは1です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Y </p> </td> 
   <td colname="col2"> <p>ポアソン：トグルを使用します。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>1 </p> </td> 
   <td colname="col5"> <p>デフォルトは1です。 </p> </td> 
  </tr> 
  ...
  <tr> 
   <td colname="col1"><b> レンダーエフェクト（古いシェーダー） </b> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> </td> 
   <td colname="col5"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>彩度をハイライト表示します。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>シャドウの彩度： </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>デフォルトはオン（空白）で、選択を解除= F100G0です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   <td colname="col1"><b>代替シェーダー</b> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> </td> 
   <td colname="col5"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>100 </p> </td> 
   <td colname="col5"> <p>デフォルトは50です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>a </p> </td> 
   <td colname="col2"> <p>輝度補正： </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なる：a36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なる：b36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>c </p> </td> 
   <td colname="col2"> <p>シャドウ調整： </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なります：c36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>d </p> </td> 
   <td colname="col2"> <p>調整をハイライト表示します。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なる：d36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>e </p> </td> 
   <td colname="col2"> <p>スペキュラ ハイライト </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なる：e36.207.136.177.xx </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なる：k64.138.175.60.xx.133.242 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>u &amp; s </p> </td> 
   <td colname="col2"> <p>シャドウの色相シフト </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なります：u8.1.2.3.4.5.6.7.8.s8.1.2.3.4.5.6.7.8。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>v &amp; t </p> </td> 
   <td colname="col2"> <p>色相シフトをハイライト表示します。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>形式が異なります：v8.1.2.3.4.5.6.7.8.t8.1.2.3.4.5.6.7.8。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>w </p> </td> 
   <td colname="col2"> <p>彩度の調整： </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>彩度を下げます。 </p> </td> 
   <td colname="col3"> <p> </p> </td> 
   <td colname="col4"> <p> </p> </td> 
   <td colname="col5"> <p> </p> </td> 
  </tr> 
...
<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>コンポジションの設定 </p> </th> 
   <th colname="col2" class="entry"> <p>説明 </p> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>画像オーサリングのデフォルト値。 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 =彩度（0 ～ 50）を強調します。 </li> 
      <li id="li_FE26429972F544869CDFE2DD61F39CC5">K200 = シャドウの彩度（0 ～ 400）。 </li> 
      <li id="li_FB6BAA708427428AA4A3AC2E5D3B9932">L400 = グロスベースの外挿強度（100-600）。 </li> 
      <li id="li_6B2EEEE7F0D54E078462AAFC4E4FAB42">U1 = USM （アンシャープマスク） （0-2）。 </li> 
      <li id="li_7CD4E3662A6C48F9B5895D133D28BA2A">V10 = USM半径（1 ～ 100 ピクセル）。 </li> 
      <li id="li_949B6DB4959B46A892787CD5B3AD7485">W100 = USMの量（1%-500%）。 </li> 
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = USMしきい値（0 ～ 255 レベル）。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C6E6DD90ECAB4D2B9284A25A29923DC6"> 
      ...
      <li id="li_A003B68023424DCABBF3A2CAF98C39A4">すべての最大および輝度補正がオンになっています。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      <li id="li_CC730580B54741FBBBFF507DE0FE1F15">H80 = USM量 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>シャープを使用した代替シェーダー： </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">再サンプル（スーパーサンプリング、ランダム=半分、レート=半分） </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">コントラスト （強い） </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">彩度の調整（中央の最初の頂点、エッジに沿った2番目の頂点、3番目の頂点の中間点の低） </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">シャープ（右に3/4方向） </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
