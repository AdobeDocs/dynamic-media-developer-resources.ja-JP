---
title: pos
description: デカールの位置： デカール画像のアンカー=点から、ターゲット ビネット オブジェクトによって定義されたデカールの原点までのオフセットをインチ単位で定義します。
...
デカールの位置： デカール画像のアンカー=点から、ターゲット ビネット オブジェクトによって定義されたデカールの原点までのオフセットをインチ単位で定義します。
...
マテリアル属性： デカール以外のマテリアルでは無視されます。

## 初期設定 {#section-1b66efab054c45ca8d67d6a9865020f4}

`pos=0,0`. デカールのアンカーポイントをビネット オブジェクトのデカールの原点に合わせます。
