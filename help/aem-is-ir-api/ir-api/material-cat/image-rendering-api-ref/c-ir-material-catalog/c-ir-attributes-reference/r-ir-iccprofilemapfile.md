...
description: ICC プロファイルマップファイルパス。 この画像カタログのICC プロファイルマップを含むファイルを指定します。
solution: Experience Manager
feature: Dynamic Media Classic,SDK/API
role: Developer,User
exl-id: 595a89e3-dc8d-49f1-80fe-83dee9da466a
TQID: 'https://experienceleague.adobe.com/bfivsPQDb3G1r6mhRBgfINdy-Fa-pyI6Kr5o32naefI'
...
ICC プロファイルマップファイルパス。 この画像カタログのICC プロファイルマップを含むファイルを指定します。
...
空。このマテリアル カタログにプライベート ICC プロファイルが含まれていないことを示します。
