...
TQID: 'https://experienceleague.adobe.com/tCSbSmtybRMKqnyW8pSex4Pma-D4RfDBTlOa8hGhIEg'
product_v2:
...
コマンド *`name`*&#x200B;は大文字と小文字を区別せず、文字、数字、`-` （ハイフン）、`_` （アンダースコア）、`.` （ピリオド）の組み合わせで構成される可能性があります。
