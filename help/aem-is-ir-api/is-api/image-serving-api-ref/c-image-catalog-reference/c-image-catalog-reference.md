---
description: 画像カタログは、フォントやICC プロファイルなどの画像とサポートデータに関する情報をサーバーに提供します。
...
画像カタログは、フォントやICC プロファイルなどの画像とサポートデータに関する情報をサーバーに提供します。
...
* [デフォルトカタログ](/help/aem-is-ir-api/is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-default-catalog.md)
