---
description: 特定のパフォーマンスまたはエラーのしきい値を超えた場合に、サーバーがメールアラートを送信するように設定できます。 システムは、サーバーにデプロイされたすべてのweb アプリケーションを一括で監視します。
...
特定のパフォーマンスまたはエラーのしきい値を超えた場合に、サーバーがメールアラートを送信するように設定できます。 システムは、サーバーにデプロイされたすべてのweb アプリケーションを一括で監視します。

* [標準アラート](r-standard-alerts.md)
* [ヒープスペース優先度アラート](c-heap-space-priority-alert.md)
