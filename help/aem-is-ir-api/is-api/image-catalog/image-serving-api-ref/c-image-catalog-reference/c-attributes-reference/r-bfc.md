---
title: Bfc
description: ブラウザー形式の変換を参照してください。 ブラウザ形式変換機能のオン/オフを指定します。
...
ブラウザー形式の変換を参照してください。 ブラウザ形式変換機能のオン/オフを指定します。
...
<table id="simpletable_998CF426296945FEA48D19E33B71A17E"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ブラウザー形式変換機能を使用してJPEGを変換するか、PNG 画像を小さいブラウザー固有のファイル形式に変換するかを指定します ( <span class="codeph"> true </span>) または off ( <span class="codeph"> false </span>) をクリックします。 </p> </td> 
 </tr> 
</table>
