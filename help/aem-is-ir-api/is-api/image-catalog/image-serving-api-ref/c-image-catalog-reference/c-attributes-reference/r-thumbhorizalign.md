---
description: サムネールの水平方向の配置。 wid=およびhei=で指定された返信画像の長方形または属性DefaultThumbPixで指定された返信画像の水平方向の整列を指定します。
...
サムネールの水平方向の配置。 wid=およびhei=または属性：:DefaultThumbPixで指定された返信画像の長方形で、サムネイル画像の水平方向の整列を指定します。

サムネール要求（`req=tmb`）にのみ使用されます。

## プロパティ {#section-c98f793986cd4f98a3995615e3b68f76}

列挙： 許可される値は、それぞれ左揃え、中央揃え、右揃えに対する1、2、3です。
