---
description: ブラックポイント補正： icc=を使用して明示的な選択を行わない場合に、ブラックポイント補正をカラー変換に適用するかどうかを指定します。
...
ブラックポイント補正： icc=を使用して明示的な選択を行わない場合に、ブラックポイント補正をカラー変換に適用するかどうかを指定します。

## プロパティ {#section-ea27b8089b89468bbc38e9e7154ea413}

フラグ： 黒ポイント補正を有効にするには0に設定し、無効にするには1に設定します。
