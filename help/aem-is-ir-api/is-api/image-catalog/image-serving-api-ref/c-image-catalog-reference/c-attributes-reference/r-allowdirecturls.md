...
TQID: 'https://experienceleague.adobe.com/vyvpvk5XLf-vdqHasiuWGJns5QuigFezdB0nKwbsVgI'
product_v2:
...
`src=`および`mask=` コマンドでの埋め込み絶対URLのサポートを有効または無効にします。 無効にすると、`attribute::RootUrl`に関連するURLのみが許可されます。
