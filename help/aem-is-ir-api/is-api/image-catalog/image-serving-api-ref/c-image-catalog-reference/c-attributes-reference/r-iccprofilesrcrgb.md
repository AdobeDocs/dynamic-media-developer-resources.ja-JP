---
description: RGBのデフォルト入力カラープロファイル。 カラープロファイルを埋め込まないRGBソース画像および様々な画像サービングコマンドで指定された特定のRGBカラー値（color=など）に使用する ICC カラープロファイルの名前を指定します。
...
RGBのデフォルト入力カラープロファイル。 カラープロファイルを埋め込まないRGBソース画像および様々な画像サービングコマンドで指定された特定のRGBカラー値（color=など）に使用する ICC カラープロファイルの名前を指定します。
