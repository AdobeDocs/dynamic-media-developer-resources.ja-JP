---
description: カタログ属性ファイルは、これらのカタログ管理属性を認識します。
...
カタログ属性ファイルは、これらのカタログ管理属性を認識します。
...
<table id="simpletable_010A9494BFEB45F0A46FE9709E0404CA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられている画像データファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられている静的コンテンツデータファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられたフォントマップファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連するマクロ定義ファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられたICCプロファイルマップファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>URLプリプロセッサールールを定義する関連ファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>サーバー上のファイルに書き込まれる画像のルートパス。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-synthesizefontstyles.md#reference-1b12ba881b9146c793bcb07407cacb15" type="reference" format="dita" scope="local"> SyntesifyFontStyles</a> </span> </p></td> 
  <td class="stentry"> <p>合成の太字/斜体スタイルを有効にします。 </p></td> 
 </tr> 
</table>
