---
description: カタログ属性ファイルでは、これらのカタログ管理属性が認識されます。
seo-description: カタログ属性ファイルでは、これらのカタログ管理属性が認識されます。
seo-title: カタログ管理
...
# カタログ管理{#catalog-management}

カタログ属性ファイルでは、これらのカタログ管理属性が認識されます。
...
<table id="simpletable_010A9494BFEB45F0A46FE9709E0404CA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連する画像データファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられたSVGデータファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられた静的コンテンツデータファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられているフォントマップファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられたマクロ定義ファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>関連付けられているICCプロファイルマップファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>URLプリプロセッサー規則を定義する関連ファイルの名前。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>非静的ソースデータファイル(画像、プロファイル、フォント)のルートパス </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>静的コンテンツソースデータファイルのルートパス </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>サーバー上のファイルに書き込まれた画像のルートパス。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>カタログの一致オプション </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Digimarcユーザ情報 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>カタログ注釈文字列 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-synthesizefontstyles.md#reference-1b12ba881b9146c793bcb07407cacb15" type="reference" format="dita" scope="local"> SyntesizeFontStyles</a> </span> </p></td> 
  <td class="stentry"> <p>合成太字/斜体スタイルを有効にします。 </p></td> 
 </tr> 
</table>
