---
description: 次のフィールドは、静的（非画像）コンテンツカタログでサポートされています。
...
次のフィールドは、静的（非画像）コンテンツカタログでサポートされています。
...
<table id="simpletable_D1DEF6268BA744AD804B9BA3D9AEE800"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>HTTP 応答の有効期限（有効期間）。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-static-content-data-reference/r-timestamp-static.md#reference-59a27b72f4cb4a53a3baba83214c4ded" type="reference" format="dita" scope="local"> タイムスタンプ </a></span> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ユーザー定義プロパティ。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ビデオのビットレート。 </p></td> 
 </tr> 
 <tr class="strow"> 
