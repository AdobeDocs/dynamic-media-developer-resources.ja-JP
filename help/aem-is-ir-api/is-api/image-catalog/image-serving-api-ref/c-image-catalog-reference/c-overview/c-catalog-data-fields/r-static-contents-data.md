---
description: 静的な（画像以外の）コンテンツカタログでは、次のフィールドがサポートされます。
seo-description: 静的な（画像以外の）コンテンツカタログでは、次のフィールドがサポートされます。
seo-title: 静的コンテンツデータ
...
# 静的コンテンツデータ{#static-contents-data}

静的な（画像以外の）コンテンツカタログでは、次のフィールドがサポートされます。
...
<table id="simpletable_D1DEF6268BA744AD804B9BA3D9AEE800"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>カタログレコード識別子（インデックスキー） </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-static-content-data-reference/r-expiration-static.md#reference-a7afd668ecbb4d2da65d86259aa6a28a" type="reference" format="dita" scope="local"> 有効期限</a> </span> </p></td> 
  <td class="stentry"> <p>HTTP応答の有効期限(time-to-live)。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ファイル変更のタイムスタンプ。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ユーザー定義のオブジェクトタイプ。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ユーザー定義のプロパティ。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ビデオビットレート. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ビデオサイズ </p></td> 
 </tr> 
</table>
