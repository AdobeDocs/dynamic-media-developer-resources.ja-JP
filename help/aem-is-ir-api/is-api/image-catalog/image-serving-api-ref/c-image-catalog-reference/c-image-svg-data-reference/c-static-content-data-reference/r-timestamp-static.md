---
title: TimeStamp
description: 「attribute::UseLastModified」が設定されている場合、「catalog::TimeStamp」値が HTTP 応答で Last-Modified HTTP ヘッダーとして返されます。 「attribute::UseLastModified」が設定されていない場合でも、Last-Modified ヘッダーは静的コンテンツに対して常に返されます。
