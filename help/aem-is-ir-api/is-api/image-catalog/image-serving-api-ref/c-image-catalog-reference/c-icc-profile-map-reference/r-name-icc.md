...
TQID: 'https://experienceleague.adobe.com/klzFmp-mzqqgEztP2UD8ELMUBWoPV-bRvd4aINk8NVk'
...
テキスト文字列。 必須。 ICC プロファイル マップのプライマリ インデックス キー。 各`icc::Name`値はテーブル内で一意である必要があり、「,」文字を含めることはできません。
