...
<table id="simpletable_8C9DB0DA5F2B4C068794415602B768CB"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>構文セクションでは、斜体以外のテキストはリテラルです。 この規則は、空白および記号 [ ] { } には適用されません | *. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>'リテラル' </p> </td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p><span class="varname"> のオプションの </span> 構文要素は、何度も繰り返すことはできません。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> <span class="varname"> item1 </span>| <span class="varname"> item2 </span> </span> </p> </td> 
  <td class="stentry"> <p>縦棒は、左側に単一構文の項目、または右側に項目を使用できることを示します。 選択する項目は 1 つだけです。 </p> </td> 
 </tr> 
 <tr class="strow"> 
