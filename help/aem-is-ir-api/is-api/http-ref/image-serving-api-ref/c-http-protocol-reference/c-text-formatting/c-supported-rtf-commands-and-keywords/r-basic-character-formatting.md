---
description: 基本的な文字書式を設定するには、次のコマンドを使用します。
seo-description: 基本的な文字書式を設定するには、次のコマンドを使用します。
seo-title: 基本的な文字書式
...
<table id="table_65415B84652F4E7497299AD90AE7C191"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>フォント </p> </td> 
   <td> <p> <span class="codeph"> \fonttblインデッ </span> クス。 </p> </td> 
  </tr> 
  <tr> 
   <td> <span class="codeph"> \fs <span class="varname"> N </span></span> </td> 
   <td> <p>フォントサイズ </p> </td> 
   <td> <p>ハーフポイント；初期設定は24です。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>画像サービングでは、次のRTF下線コマンドも認識されます。 </p> <p> 
     ...
     </ul> </p> <p>これらは、現時点で標準の\ul下線として実 <span class="codeph"> 装され </span> ています。 その他のRTF下線コマンドはすべて無視されます。 </p> </td> 
  </tr> 
  <tr> 
