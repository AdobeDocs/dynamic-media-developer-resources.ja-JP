---
title: RTF エンコーディングの例
description: 次の例は、テキストコマンドの例と、テキストへの影響を示しています。
...
![RTF エンコーディングの例： 3 つの画像](assets/rtf03.png)
...
![RTF エンコーディングの例： 4 つの画像](assets/rtf04.png)
...
![RTF エンコーディングの例 8 画像](assets/rtf08.png)
