...
description: 次の例は、テキストコマンドの例と、テキストコマンドがテキストにどのように影響するかを示しています。
...
![RTF エンコーディングの例3つの画像](assets/rtf03.png)
...
![RTF エンコーディングの例4つの画像](assets/rtf04.png)
...
![RTF エンコーディングの例8つの画像](assets/rtf08.png)
...
![RTF エンコーディングの例10枚の画像](assets/rtf09.png)
