...
description: 次の例は、テキスト コマンドの例と、テキストへの影響を示しています。
...
![RTF エンコーディングの例 8 イメージ ](assets/rtf08.png)
