---
description: 使用可能なロケール固有のバージョン。 リクエストパスで指定されたカタログ IDの使用可能なロケール固有のバージョンのリストを返します。
...
使用可能なロケール固有のバージョン。 リクエストパスで指定されたカタログ IDの使用可能なロケール固有のバージョンのリストを返します。
...
[&#x200B; オブジェクト Idの翻訳](../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-object-id-translation.md#reference-cf3e34e6cbb346d69ded9982bfdef414)を参照してください。
