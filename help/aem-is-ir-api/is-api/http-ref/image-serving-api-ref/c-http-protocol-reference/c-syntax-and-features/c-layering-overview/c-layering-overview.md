---
title: レイヤーの概要
description: 画像サービングでは、任意の数の画像、テキスト、単色のレイヤーを組み合わせて 1 つの合成画像にすることができます。
...
画像サービングを使用すると、任意の数の画像、テキスト、単色のレイヤーを組み合わせて 1 つの合成画像にすることができます。
...
* [サイズ](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-size-reference.md)
* [接触チャネル =](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-origin.md)
* [アンカー=](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-anchor.md)
