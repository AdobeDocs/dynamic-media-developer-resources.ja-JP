---
title: レイヤーの概要
description: 画像サービングでは、任意の数の画像、テキスト、べた塗りのレイヤーを組み合わせて、合成画像にすることができます。
...
画像サービングでは、任意の数の画像、テキストおよびべた塗りのレイヤーを組み合わせて、1 つの合成画像にすることができます。
...
* [テキスト=](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-text.md)
