---
description: これらのコマンドは、画像、テキストおよび単色レイヤーに適用されます。 また、一般的に、合成画像やシンプルでレイヤー化されていない画像リクエストにも便利です。
...
これらのコマンドは、画像、テキストおよび単色レイヤーに適用されます。 また、一般的に、合成画像やシンプルでレイヤー化されていない画像リクエストにも便利です。
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーデータを色付けします。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-flip.md#reference-f8568a61b77c41569d382a3147964ce3" type="reference" format="dita" scope="local"> フリップ </a> </p></td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-perspective.md#reference-c941f3bb1eee4dd29abf3824c0b0bc8e" type="reference" format="dita" scope="local"> パースペクティブ </a> </p></td> 
  <td class="stentry"> <p>レイヤーを遠近法で変形します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーのクリップの反転シェイプを指定します。 </p></td> 
 </tr> 
</table>
