---
description: これらのコマンドは、画像、テキストおよびべた塗りのレイヤーに適用されます。 また、一般に、合成画像や、単純な非レイヤー画像リクエストにも便利です。
seo-description: これらのコマンドは、画像、テキストおよびべた塗りのレイヤーに適用されます。 また、一般に、合成画像や、単純な非レイヤー画像リクエストにも便利です。
seo-title: 一般的な操作
...
これらのコマンドは、画像、テキストおよびべた塗りのレイヤーに適用されます。 また、一般に、合成画像や、単純な非レイヤー画像リクエストにも便利です。
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーをぼかします。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーデータに色を付けます。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>すべての色の色相をシフトします。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>色の彩度を調整します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>シンプルなシャープを適用します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-flip.md#reference-f8568a61b77c41569d382a3147964ce3" type="reference" format="dita" scope="local"> 反転</a> </p></td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-perspective.md#reference-c941f3bb1eee4dd29abf3824c0b0bc8e" type="reference" format="dita" scope="local"> 視点</a> </p></td> 
  <td class="stentry"> <p>レイヤーを遠近法によって変換します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーのクリップシェイプを指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーの反転したクリップの形状を指定します。 </p></td> 
 </tr> 
</table>
