---
description: これらのコマンドは、画像、テキスト、およびべた塗りのカラーレイヤーに適用されます。 また、合成画像や、単純な非レイヤー画像リクエストにも一般に便利です。
...
これらのコマンドは、画像、テキスト、およびべた塗りのカラーレイヤーに適用されます。 また、合成画像や、単純な非レイヤー画像リクエストにも一般に便利です。
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>画層データに色を付けます。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤにノイズを追加します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーを水平または垂直に反転します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>画層を回転します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーをパースペクティブ変換します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤのクリップシェイプを指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーの反転クリップシェイプを指定します。 </p></td> 
 </tr> 
</table>
