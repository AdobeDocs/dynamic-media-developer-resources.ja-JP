---
description: これらのコマンドは、画像、テキスト、およびべた塗りのカラーレイヤーに適用されます。 ほとんどは、複合画像や、単純な、レイヤー化されていないリクエストには意味がありません。 エフェクトレイヤには適用されません。
...
# 共通のレイヤコマンド{#common-layer-commands}

これらのコマンドは、画像、テキスト、およびべた塗りのカラーレイヤーに適用されます。 ほとんどは、複合画像や、単純な、レイヤー化されていないリクエストには意味がありません。 エフェクトレイヤには適用されません。
...
<table id="simpletable_8A74E965537D4E8CB91E95AEAE9673E0"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-extend.md#reference-7e9156beb285459d830e2d56782a74ac" type="reference" format="dita" scope="local"> 拡張</a> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>このレイヤのイメージマップを定義します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-origin.md#reference-e11c7ac06e2240cc884c3fec98f05138" type="reference" format="dita" scope="local"> origin</a> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤをレイヤ0を基準に配置します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤサイズの拘束を指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
