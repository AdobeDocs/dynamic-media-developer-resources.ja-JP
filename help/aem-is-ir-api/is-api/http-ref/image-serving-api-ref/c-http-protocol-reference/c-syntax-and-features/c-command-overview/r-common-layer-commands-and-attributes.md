---
description: これらのコマンドは、画像、テキストおよびべた塗りのレイヤーに適用されます。 ほとんどの場合、合成画像や単純な、レイヤー化されていない要求には意味がありません。 エフェクトレイヤーには適用されません。
seo-description: これらのコマンドは、画像、テキストおよびべた塗りのレイヤーに適用されます。 ほとんどの場合、合成画像や単純な、レイヤー化されていない要求には意味がありません。 エフェクトレイヤーには適用されません。
seo-title: 一般的なレイヤーコマンド
...
これらのコマンドは、画像、テキストおよびべた塗りのレイヤーに適用されます。 ほとんどの場合、合成画像や単純な、レイヤー化されていない要求には意味がありません。 エフェクトレイヤーには適用されません。
...
<table id="simpletable_8A74E965537D4E8CB91E95AEAE9673E0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤーの長方形を拡張（切り抜き）します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-origin.md#reference-e11c7ac06e2240cc884c3fec98f05138" type="reference" format="dita" scope="local"> 起源</a> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>レイヤー0を基準にしてレイヤーを配置します。 </p></td> 
 </tr> 
 <tr class="strow"> 
