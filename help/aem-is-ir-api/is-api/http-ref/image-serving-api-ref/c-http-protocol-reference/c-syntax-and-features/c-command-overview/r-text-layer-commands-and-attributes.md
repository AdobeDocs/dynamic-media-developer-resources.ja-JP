...
seo-description: これらのコマンドは、共通のレイヤーコマンドに加えて、テキストレイヤーにも適用されます。
seo-title: テキストレイヤーのコマンド
...
<table id="simpletable_DBCF90E140684FD19098EA810369337B"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>追加のテキスト属性を設定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>テキストを描画するパスを指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>追加のテキストパス属性を設定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>テキストフローの除外領域を指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>テキストの基準角度を設定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-text.md#reference-84634052e48548539a1ef63cbe41f22f" type="reference" format="dita" scope="local"> テキスト</a> </p></td> 
