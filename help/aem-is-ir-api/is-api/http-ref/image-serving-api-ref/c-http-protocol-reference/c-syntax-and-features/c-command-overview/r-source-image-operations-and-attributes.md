---
description: これらのコマンドは、シンプルなリクエストまたは画像レイヤーで使用されるソースイメージと、単色レイヤーにアタッチされたマスクに適用されます。
...
# Sourceの画像操作{#source-image-operations}

これらのコマンドは、シンプルなリクエストまたは画像レイヤーで使用されるソースイメージと、単色レイヤーにアタッチされたマスクに適用されます。
...
<table id="simpletable_86AF12F2BD0B4F8698A008F8A20BAEF0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ソース画像を切り抜くか、拡張します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>別のソース画像マスクを指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ソース画像のマスクまたはアルファチャンネルの使用を指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>解像度に基づいてソースイメージを拡大・縮小します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-scale.md#reference-098c30cea1764f189e6f7c7e400cc065" type="reference" format="dita" scope="local">尺度</a> </p></td> 
  <td class="stentry"> <p>スケール係数を使用してソース画像を拡大・縮小します。 </p></td> 
 </tr> 
</table>
