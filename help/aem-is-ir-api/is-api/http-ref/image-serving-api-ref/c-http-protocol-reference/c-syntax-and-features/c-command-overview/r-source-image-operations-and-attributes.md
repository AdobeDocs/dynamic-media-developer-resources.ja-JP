---
description: これらのコマンドは、単純な要求または画像レイヤーで使用されるソース画像と、べた塗りレイヤーにアタッチされるマスクに適用されます。
seo-description: これらのコマンドは、単純な要求または画像レイヤーで使用されるソース画像と、べた塗りレイヤーにアタッチされるマスクに適用されます。
seo-title: ソース画像の操作
...
これらのコマンドは、単純な要求または画像レイヤーで使用されるソース画像と、べた塗りレイヤーにアタッチされるマスクに適用されます。
...
<table id="simpletable_86AF12F2BD0B4F8698A008F8A20BAEF0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>拡大・縮小率を使用して、ソース画像を拡大・縮小します。 </p></td> 
 </tr> 
</table>
