---
description: これらのコマンドは、単純なリクエストまたは画像レイヤーで使用されるソース画像と、単色レイヤーにアタッチされたマスクに適用されます。
...
# Source画像の操作{#source-image-operations}

これらのコマンドは、単純なリクエストまたは画像レイヤーで使用されるソース画像と、単色レイヤーにアタッチされたマスクに適用されます。
...
<table id="simpletable_86AF12F2BD0B4F8698A008F8A20BAEF0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ソース画像をトリミングまたは拡張します。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>個別のソース イメージ マスクを指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>解像度に基づいてソース イメージをスケールします。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-scale.md#reference-098c30cea1764f189e6f7c7e400cc065" type="reference" format="dita" scope="local"> スケール </a> </p></td> 
  <td class="stentry"> <p>尺度係数を使用してソース イメージを尺度変更します。 </p></td> 
 </tr> 
</table>
