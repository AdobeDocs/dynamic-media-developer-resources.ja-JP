---
description: これらのコマンドは、ドロップシャドウや光彩効果などのレイヤー効果を定義するために使用できます。 エフェクトレイヤーは、他のすべてのコマンドを無視します。
...
これらのコマンドは、ドロップシャドウや光彩効果などのレイヤー効果を定義するために使用できます。 エフェクトレイヤーは、他のすべてのコマンドを無視します。
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-effect.md#reference-b1296c4afed047fb921bbc1e33752135" type="reference" format="dita" scope="local"> 効 </a> </p></td> 
  <td class="stentry"> <p>エフェクトレイヤーのセグメントを開始し、z オーダーを指定します。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>効果を羽毛にします。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>エフェクトレイヤーを親レイヤーに相対的に配置します。 </p></td> 
 </tr> 
</table>
