---
description: インストール後、install_rootのフォルダ階層には、次に示すファイルとフォルダが含まれます。
seo-description: インストール後、install_rootのフォルダ階層には、次に示すファイルとフォルダが含まれます。
seo-title: 目次
...
インストール後、install_rootのフォルダ階層には、次に示すファイルとフォルダが含まれます。

>[!NOTE]
>
>追加のファイルとフォルダーが存在し、変更を加えないでください。
...
<table id="table_F9FE5E0622A54CCD88461078FD5EA3DC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>画像サービングのインストールのルートフォルダ </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>画像サービングを開始および停止するスクリプト。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>画像サービングの画像変換ユーティリティ </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> PsLayers (.exe) </span> </p> </td> 
   <td colname="col4"> <p>Photoshopテキストレイヤー変数の抽出。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>画像レンダリングビネット、キャビネット、ウィンドウカバリングコンバータユーティリティ。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> cache/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>データキャッシュフォルダー；をインストールする際、または手動で設定ファイルを編集する際に設定できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> catalog-bin/ </span> </p> </td> 
   <td colname="col4"> <p>PSはコンパイルされたカタログデータをここに保存します。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>IS画像カタログフォルダ；をインストールする際、または手動で設定ファイルを編集する際に設定できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <span class="codeph"> サーバーが </span>機能するには、Default.iniが必要です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>すべてのPSおよびISログデータがこのフォルダに書き込まれます。設定ファイルを手動で編集します。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>イメージレンダリングのインストールのルートフォルダ </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> バックアップ/ </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> カタログ/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>画像レンダリングカタログフォルダ；をインストールする際、または手動で設定ファイルを編集する際に設定できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
