...
user-guide-title: Dynamic Media画像サービングおよびレンダリング API
...
# Dynamic Media画像サービングおよびレンダリング API {#image-serving-api}

+ [Dynamic Media画像サービングと画像レンダリング API ホーム](homeisir.md)
+ [このリリースについて](r-about-this-release.md)
+ [必要システム構成と前提条件](r-requirements-and-prerequisites.md)
+ [ディスク領域の要件と推奨事項](r-disk-space-reqs.md)
...
+ インストール {#install}
   ...
   + [コンテンツ](c-installation/c-contents.md)
   + [フォルダーをインストール](c-installation/c-install-folder.md)
   + Windowsへのインストール {#windows-install}
      + [Windowsへのインストール](c-installation/t-installing-on-windows/t-installing-on-windows.md)
      + [初めてのインストール](c-installation/t-installing-on-windows/t-first-time-installation-win.md)
      + [管理者とは異なるユーザーアカウントでのインストール](c-installation/t-installing-on-windows/t-diff-account-win.md)
      + [IS 4.7.4以降からの更新](c-installation/t-installing-on-windows/t-update-win.md)
      + [インストールの確認](c-installation/t-installing-on-windows/t-verify-win.md)
   + Linuxでのインストール {#linux-install}
      + [Linuxでのインストール](c-installation/c-installing-linux/c-installing-linux.md)
      + [初めてのインストール](c-installation/c-installing-linux/t-first-install-lin.md)
      + [IS 4.7.4以降からの更新](c-installation/c-installing-linux/t-update-lin.md)
   ...
   + 画像サービングの開始と停止 {#start-stop-image-servicing}
      ...
      + [Windowsでの起動または停止](c-installation/t-starting-and-stopping/t-startstop-windows.md)
      + [Linuxでの起動または停止](c-installation/t-starting-and-stopping/t-startstop-linux.md)
+ 画像サービス API {#image-serving-api}
   ...
   + 設定と管理 {#config-admin}
      ...
      + サーバー設定ファイル {#server-config-files}
      ...
      + サーバー設定 {#server-settings}
         ...
         + [Debug_trace ロギング](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-debug-trace-logging.md)
         ...
         + [監視およびアラートシステム](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-monitoring-and-alerting-system.md)
      ...
      + サーバー監視 {#server-monitoring}
         ...
         + [ヒープスペース優先度アラート](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-monitoring/c-heap-space-priority-alert.md)
      + コンテンツの管理 {#manage-content}
         ...
         + [静的なコンテンツソースデータ](is-api/image-serving-api-ref/c-configuration-and-administration/c-managing-content/c-static-content-source-data.md)
   ...
   + [静的（画像でない）コンテンツの提供](is-api/image-serving-api-ref/c-serving-static-nonimage-contents.md)
   + [トラブルシューティング](is-api/image-serving-api-ref/r-troubleshooting.md)
   + HTTP プロトコル参照 {#http-protocol-reference}
      + [HTTP プロトコル参照の概要](is-api/image-serving-api-ref/c-http-protocol-reference/c-http-protocol-reference.md)
      ...
      + 構文と機能 {#syntax-and-features}
         ...
         + [Image Serving HTTP プロトコルの基本構文](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-basic-syntax.md)
         + Image Serving HTTP protocol コマンド {#image-serving-http}
            + [Image Serving HTTP protocol コマンドの概要](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/c-command-overview.md)
            ...
            + [共通操作](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-common-operations-and-attributes.md)
            + [Sourceの画像操作](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-source-image-operations-and-attributes.md)
            ...
            + [画像レイヤーコマンド](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-image-layer-commands-and-attributes.md)
            ...
            + [レイヤーエフェクトコマンド](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-layer-effect-commands-and-attributes.md)
         + レイヤー {#layering}
            ...
            + [レイヤー名](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-named-layers.md)
         + [レイヤー効果](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-layer-effects.md)
         + [ネスト化と埋め込みをリクエスト](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-nesting-and-embedding.md)
         + [置換変数](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-is-http-substitution-variables.md)
         ...
         + [オブジェクト IDの翻訳](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-object-id-translation.md)
         ...
         + [リクエストの難読化](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-obfuscation.md)
      ...
      + テキスト書式設定 {#text-formatting}
         + [テキスト書式設定の概要](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-text-formatting.md)
         ...
         + [コピーフィット](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-copy-fitting.md)
         ...
         + [予約済み文字](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-reserved-characters.md)
         + RTF サポート {#rtf-support}
            + [サポートされているRTF コマンドとキーワード](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/c-supported-rtf-commands-and-keywords.md)
            + [文書（テキストボックス）のプロパティ](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-document-text-box-properties.md)
            ...
            + [基本的な文字フォーマット](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-basic-character-formatting.md)
            + [詳細テキスト書式設定](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/r-advanced-text-formatting.md)
      ...
      + コマンド参照 {#command-reference}
         ...
         + [エフェクト](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-effect.md)
         ...
         + [へい](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-hei.md)
         ...
         + [オリジン](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-origin.md)
         ...
         + [遠近法](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-perspective.md)
         ...
         + [拡大・縮小](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-scale.md)
      ...
      + サーバー動作 {#server-behavior}
         + [サーバー動作に関する注意事項](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/c-notes-on-server-behavior.md)
         ...
         + [レイヤーの変形](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-layer-transforms.md)
         ...
         + [サムネールール](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-thumbnail-rules.md)
         + [レイヤーの配置](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-layer-placement.md)
         + [画像の変形を表示](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-images.md)
         + [サムネールの変形を表示](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-view-transform-for-thumbnails.md)
      + テンプレート {#templates}
         ...
         + [例B](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-templates/r-example-b.md)
         + [例C](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-templates/r-example-c.md)
   + FXG サーバープロトコル リファレンス {#fxg-server-protocol-ref}
      + [FXG サーバープロトコル リファレンス](is-api/image-serving-api-ref/c-is-fxg-server-protocol/c-is-fxg-server-protocol.md)
      + FXG サーバープロトコル {#fxg-server-protocol}
         ...
         + FXG サーバープロトコル リファレンス {#protocol-ref}
            + [FXG サーバープロトコル リファレンスの概要](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/c-fxg-server-protocol-reference.md)
            + [裁ち落とし](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-bleedmargin.md)
            ...
            + [へい](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-is-fxg-hei.md)
            ...
            + [拡大・縮小](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-is-fxg-scale.md)
         ...
         + [置換変数](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/r-is-fxg-substitution-variables.md)
   ...
   + 画像カタログ参照 {#image-catalog-reference}
      ...
      + [デフォルトカタログ](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-default-catalog.md)
      + カタログ属性 {#catalog-attributes}
         ...
         + [共通サムネール属性](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-attributes/r-common-thumbnail-attributes.md)
      ...
      + カタログデータフィールド {#catalog-data-fields}
         ...
         + [マクロ定義](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-data-fields/r-macro-definitions.md)
   ...
   + 属性 {#attributes}
      ...
      + [サムレス](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-thumbres.md)
   ...
   + Image/SVG データリファレンス {#image-svg-ref}
      + [Image/SVG データリファレンス](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-svg-data-reference.md)
      + 画像データ参照 {#image-data-reference}
         ...
         + [サムレス](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-data-reference/r-thumbres-cat.md)
      ...
      + SVG データリファレンス {#svg-data-reference}
         + [SVG データリファレンス](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-svg-data-reference/c-svg-data-reference.md)
   ...
   + フォントマップ {#font-map}
      + [フォントマップ参照](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-font-map-reference/c-font-map-reference.md)
   ...
   + ルールセット参照 {#rule-set-reference}
      + [ルールセット参照](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-rule-set-reference/c-rule-set-reference.md)
      ...
      + [代用](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-rule-set-reference/r-substitution-rule.md)
   + [画像サーバープロキシ](is-api/image-serving-api-ref/r-image-server-proxy.md)
   + {hide-from-toc}[Image Serverの例](is-api/image-serving-api-ref/r-examples-is.md)
   + レスポンシブ静止画像ライブラリ {#responsive-static-image-library}
      + [レスポンシブ静止画像ライブラリ](is-api/image-serving-api-ref/c-about-responsive-static-image-library/c-about-responsive-static-image-library.md)
...
+ 画像レンダリング API {#image-rendering-api}
   ...
   + 設定 {#configuration}
      ...
      + 画像レンダリングのアンインストール {#uninstalling-image-rendering}
         ...
         + [LinuxおよびSolarisでのアンインストール](ir-api/image-rendering-api-ref/c-ir-installation/c-ir-uninstalling/t-ir-uninstall-linux-solaris.md)
   ...
   + サーバー管理 {#server-administration}
      ...
      + [サーバー管理の序文](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-preface.md)
      ...
      + サーバーの設定と管理 {#configuring-and-managing-the-server}
         + [サーバーの概要の設定と管理](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-configuring-and-managing-the-server.md)
         ...
         + [ダイナミックディスク領域に関する考慮事項](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-dynamic-disk-space-considerations.md)
         + [周辺光量補正サイズの制限](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuring-and-managing-the-server/c-ir-vignette-size-limitation.md)
      ...
      + 設定設定リファレンス {#configuration-settings-reference}
         ...
         + [カタログフォルダー（ir.catalogRootPath）](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-catalog-folder.md)
   ...
   + HTTP プロトコル参照 {#http-protocol-reference}
      + [HTTP プロトコル参照](ir-api/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-ref.md)
      ...
      + HTTP プロトコルの構文と機能 {#http-protocol-syntax}
         ...
         + イメージ レンダリング HTTP プロトコル コマンドの概要 {#image-rendering-http-protocol-command-overview}
            + [イメージ レンダリング HTTP プロトコル コマンドの概要](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/c-ir-command-overview.md)
            ...
            + [その他コマンド](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/r-ir-miscellaneous-commands.md)
         + ビネット {#vignettes}
            ...
            + [マテリアル解像度](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md)
         + マテリアル {#materials}
            ...
            + [べた塗](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-solid-colors.md)
            ...
            + [壁の境界線](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-wall-borders.md)
            ...
            + [ウィンドウのカバー](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-window-coverings.md)
         + 高度なレンダーエフェクト {#advanced-render-effects}
            + [高度なレンダーエフェクト](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-advanced-render-effects.md)
            + [複数のイルミネーション マップの使用](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-use-multiple-illumination-maps.md)
            + [マテリアルの色付け](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-colorizing-materials.md)
            ...
            + [リフレクション](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/r-ir-reflections.md)
            ...
            + [レンダーの詳細設定](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-advanced-render-settings.md)
         + ネスト化と埋め込みをリクエスト {#request-nesting-and-embedding}
            + [ネスト化と埋め込みをリクエスト *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-request-nesting-and-embedding.md)
            + [埋め込みImage Server リクエスト](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-embedded-image-serving-requests.md)
            ...
            + [外国の画像ソース](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-foreign-image-sources.md)
         ...
         + [リクエストの事前処理*](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-pre-processing.md)
      ...
      + HTTP プロトコルコマンドリファレンス {#http-protocol-command-reference}
         ...
         + [へい](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-hei.md)
         ...
         + [イルム](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-illum.md)
         ...
         + [ラフ](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-rough.md)
         ...
         + [サブ](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-sub.md)
   ...
   + マテリアルカタログ {#material-catalog}
      + [マテリアルカタログ](ir-api/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-catalog.md)
      ...
      + マテリアルデータ参照 {#material-data-reference}
         + [マテリアルデータ参照](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/c-ir-material-data-reference.md)
         ...
         + [ラフネス](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-roughness.md)
      ...
      + 周辺光量補正マップ参照 {#vignette-map-reference}
         + [周辺光量補正マップ参照](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/c-ir-vignette-map-reference.md)
      ...
      + ルールセット参照 {#rule-set-reference}
         + [ルールセット参照](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-rule-set-reference/c-ir-rule-set-reference.md)
         ...
         + [代用](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-rule-set-reference/r-ir-substitution.md)
+ ユーティリティ {#utilites}
   ...
   + 周辺光量変換（vntc）{#vignette-converter-vntc}
      + [周辺光量変換（vntc）](utilities/c-ir-vignette-converter-vntc/c-ir-vignette-converter-vntc.md)
      + [周辺光量変換](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-converter.md)
      + [周辺光量補正](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-scaling.md)
      ...
      + [周辺光量補正のオプション](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-options-for-vignettes.md)
      + [キャビネットスタイルファイルのオプション](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-options-for-cabinet-style-files.md)
      + [返品](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-returns.md)
      + [Output](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-output.md)

<!--
Comment from the first link in the TOC:
(https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/image-serving-api/homeisir.html?lang=ja)
